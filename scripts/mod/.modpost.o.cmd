cmd_scripts/mod/modpost.o := ccache gcc -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -Ofast -fomit-frame-pointer -std=gnu89      -c -o scripts/mod/modpost.o scripts/mod/modpost.c
